        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen} >
            <DialogTrigger asChild className='p-4 flex-1 min-w-[130px] max-w-[200px] h-full hover:shadow-2xl hover:bg-linear-to-r from-[#F8F8E1] to-[#8ACCD5]'>
                <Card className='p-4 flex-1 min-w-[130px] h-full'>
                    <CardHeader>
                        <CardTitle className='flex justify-between items-center text-center'>ADD TEACHER</CardTitle>
                    </CardHeader>
            ...
            <DialogContent>
                <DialogTitle className='text-center'>Add a teacher</DialogTitle>
                <TeacherForm closeDialog={()=> setIsOpen(false)}/>
            </DialogContent>
        </Dialog>
  )
}
